...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="text-center space-y-6">
            ...
            <div className="flex flex-col gap-3 pt-2">
              <Link to="/auth" className="w-full">
                <Button size="lg" className="w-full bg-rose-500 hover:bg-rose-600 text-white text-base px-8 py-6 shadow-lg touch-target active:scale-95 transition-transform">
              ...
              <Button 
                variant="outline" 
                size="lg" 
                className="w-full text-base px-8 py-6 border-rose-200 hover:bg-rose-50 dark:hover:bg-rose-950/20 touch-target active:scale-95 transition-transform"
            ...
            <div className="grid grid-cols-3 gap-4 pt-4">
              <div className="text-center">
                <div className="text-xl font-bold text-rose-500 mb-1">24/7</div>
                <div className="text-xs text-muted-foreground leading-tight">Emergency<br/>Support</div>
              </div>
              <div className="text-center">
                <div className="text-xl font-bold text-rose-500 mb-1">5K+</div>
                <div className="text-xs text-muted-foreground leading-tight">Mamas<br/>Protected</div>
              </div>
              <div className="text-center">
                <div className="text-xl font-bold text-rose-500 mb-1">98%</div>
                <div className="text-xs text-muted-foreground leading-tight">Alert<br/>Success</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="px-4 py-12 bg-gradient-to-br from-white to-rose-50/30 dark:from-gray-900 dark:to-rose-950/10">
